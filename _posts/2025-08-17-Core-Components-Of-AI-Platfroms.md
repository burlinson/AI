...
subtitle: >-
  Retrieval Pipelines, Neural Networks, Embeddings, Vector Databases, RAG, LLM &
  Prompt Frameworks
...
![Simple AI Platform](/assets/img/AIPlatformSImple.webp){: .mx-auto .d-block :}
...
The diagram above is a simplified outline to demonstrate conceptually how the components interact. There are other components not shown here, and there are also other more complex workflows. For example, in more advanced AI platforms the prompt framework might trigger additional calls on the retrieval pipelines for more timely or more accurate data.
